      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // Left: branch selector + file tree + README.
              Expanded(
                flex: 7,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Row(
                      children: [
                        ...
                        OutlinedButton.icon(
                          ...
                          onPressed: () =>
                              context.go('/$_fullPath/commits/$ref'),
                        ),
                      ],
                    ),
                    ...
                    if (_readme != null)
                      MarkdownView(
                          data: _readme!.content, title: _readme!.path),
                  ],
                ),
              ),
              const SizedBox(width: 16),
              // Right: clone box + meta.
              Expanded(
                flex: 3,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CloneUrlBox(
                      httpsUrl: api.httpCloneUrl(project.fullPath),
                      sshUrl: api.sshCloneUrl(project.fullPath),
                    ),
